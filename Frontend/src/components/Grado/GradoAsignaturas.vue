...
<template>
  <div class="card shadow-sm border-0">
    <div
      class="card-header bg-indigo text-white fw-bold d-flex justify-content-between align-items-center"
    >
            ...
            <tr :class="{ 'table-active': asignaturaExpandida === asig.id }">
              ...
              <td class="d-flex justify-content-end gap-2 pe-2">
                <button
                  class="btn btn-sm"
                  :class="
                    asignaturaExpandida === asig.id ? 'btn-indigo text-white' : 'btn-outline-indigo'
                  "
                ...
                >
                  ...
                  <i
                    :class="
                      asignaturaExpandida === asig.id ? 'bi bi-chevron-up' : 'bi bi-chevron-down'
                    "
                  ></i>
                </button>

                <button @click="abrirEliminarModal(asig)" class="btn btn-sm btn-outline-danger">
                  Eliminar
                </button>
              </td>
            </tr>
