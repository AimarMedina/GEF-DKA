    ...
    <div v-if="isAdmin" class="row g-4 justify-content-center">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink to="/grados" class="img-link">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/GradosAsignaturas.png"
              class="card-img-top w-100 h-100 object-fit-cover"
              alt="Grados"
            />
          </div>
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink to="/competenciasXra" class="img-link">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/CompetenciasRas.png"
              class="card-img-top w-100 h-100 object-fit-cover"
              alt="Competencias"
            />
          </div>
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink to="/empresa" class="img-link">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/Empresas.png"
              class="card-img-top w-100 h-100 object-fit-cover"
              alt="Empresas"
            />
          </div>
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink to="/importarDatos" class="img-link">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/ImportarDatos.png"
              class="card-img-top w-100 h-100 object-fit-cover"
              alt="Importar"
            />
          </div>
    ...
    <div v-else-if="isTutor" class="row g-4 justify-content-center">
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink :to="`/cuadernos-tutor`">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/Cuadernos.png"
              class="card-img-top w-100 h-100 object-fit-cover"
      ...
      <div v-if="isTutorGrado" class="col-12 col-md-6 col-lg-4">
        <RouterLink to="/mi-grado">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/MiGrado.png"
              alt="Imagen de Mi Grado tutor"
              class="card-img-top w-100 h-100 object-fit-cover"
            />
          </div>
        </RouterLink>
    ...
    <div v-else-if="isAlumno" class="row g-4">
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink :to="`/alumno/${usuario.id}/estancia`">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/Estancia.png"
              class="card-img-top w-100 h-100 object-fit-cover"
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <RouterLink to="/alumno/mis-notas">
          <div class="card h-100 border-0 shadow hover-scale overflow-hidden">
            <img
              src="../../public/images/MisNotas.png"
              class="card-img-top w-100 h-100 object-fit-cover"
              alt="Notas de Alumno"
            />
          </div>
